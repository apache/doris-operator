...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSituation) DeepCopyInto(out *ClusterSituation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSituation.
func (in *ClusterSituation) DeepCopy() *ClusterSituation {
	if in == nil {
		return nil
	}
	out := new(ClusterSituation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DorisClusterStatus) DeepCopyInto(out *DorisClusterStatus) {
	*out = *in
	...
	out.ClusterSituation = in.ClusterSituation
}
